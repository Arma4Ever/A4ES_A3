...
diag_log ["surgicalKitProgress", _this];
...
if (_totalTime - _elapsedTime > ([_medic, _patient, _bodyPart] call FUNC(getStitchTime)) - GVAR(singleWoundStitchTime)) exitWith {true};
