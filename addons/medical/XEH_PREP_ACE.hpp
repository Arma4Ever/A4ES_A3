...
PREP(handleKilled);
PREP(handleLocal);
DFUNC(handleBandageOpening) = compileFinal preProcessFileLineNumbers "\z\a3cs\addons\medical\functions\fnc_handleBandageOpening.sqf";//PREP(handleBandageOpening);
PREP(hasItem);
PREP(hasItems);
...
DFUNC(treatmentAdvanced_bandageLocal) = compileFinal preProcessFileLineNumbers "\z\a3cs\addons\medical\functions\fnc_treatmentAdvanced_bandageLocal.sqf";//PREP(treatmentAdvanced_bandageLocal);
