...
private _repairTime = (damage _vehicle) * 60;
...
[
    ...
    [_vehicle, _player, _object],
    {
        ...
        [localize LSTRING(Module_SupplyPoint_Action_RepairVehicle_Success), 2, _player] call ace_common_fnc_displayTextStructured;
    ...
    {
        (_this select 0) params ["_vehicle", "_player", "_object"];
        [localize LSTRING(Module_SupplyPoint_Action_RepairVehicle_Fail), 2, _player] call ace_common_fnc_displayTextStructured;
        [_vehicle, "blockEngine", "A3CS_supplyPoint", false] call ace_common_fnc_statusEffect_set;
        _object setVariable [QGVAR(busy), false, true];
    },
    localize LSTRING(Module_SupplyPoint_Action_RepairVehicle_Progress),
    _condition,
    ["isNotOnLadder"]
