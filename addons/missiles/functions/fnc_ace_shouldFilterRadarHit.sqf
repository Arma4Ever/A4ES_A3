...
if (isEngineOn _target && {(_target isKindOf "Helicopter") || {_target isKindOf "Ship"}}) exitWith {
    TRACE_3("dont filter helicopters/ships",_target isKindOf "Helicopter",_target isKindOf "Ship",isEngineOn _target);
    false
};
//------ EDIT
