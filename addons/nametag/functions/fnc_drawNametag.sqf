...
params ["_target"];
private ["_nameTag", "_uiNametag", "_uiNameTagCtrl", "_unitData"];

_nameTag = 3000 cutRsc [QGVAR(tag), "PLAIN"];
_uiNametag = uiNameSpace getVariable [QGVAR(tag), displayNull];
if(isNull _uiNametag) exitWith {};

_uiNameTagCtrl = _uiNametag displayCtrl 3600;
