class CfgAmmo {
    ...
    class DMR_Laser_Ammo: BulletBase {
        ...
        soundHit1[] = {QPATHTOF(data\lhit),1.9952624,1,120};
        soundHit2[] = {QPATHTOF(data\lhit),1.9952624,1,120};
        soundHit3[] = {QPATHTOF(data\lhit),1.9952624,1,120};
        soundHit4[] = {QPATHTOF(data\lhit),1.9952624,1,120};
        soundHit5[] = {QPATHTOF(data\lhit),1.9952624,1,120};
        soundHit6[] = {QPATHTOF(data\lhit),1.9952624,1,120};
