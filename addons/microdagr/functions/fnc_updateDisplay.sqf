...
case (APP_MODE_SETUP): {
        ...
        _settingListBox lbAdd "Nadawanie pozycji";
        ...
        _settingListBox lbAdd "Odbieranie pozycji";
        ...
        _settingListBox lbAdd "Pokazuj markery";
        if (GVAR(settingShowAllMarkers)) then {
            _settingListBox lbSetTextRight [4, "Wszystkie"];
        } else {
            _settingListBox lbSetTextRight [4, "Tylko grupy"];
        };
        _settingListBox lbSetSelectColorRight [4, [1, 1, 1, 1]];

        _settingListBox lbAdd "Call sign";
        if(GVAR(settingMarkerName) != "") then {
            _settingListBox lbSetTextRight [5, GVAR(settingMarkerName)];
        } else {
            _settingListBox lbSetTextRight [5, "Brak"];
        };
        _settingListBox lbSetSelectColorRight [5, [1, 1, 1, 1]];

        _settingListBox lbAdd "Symbol";
        if(GVAR(settingMarkerIcon) == 0) then {
            _settingListBox lbSetTextRight [6, "Auto"];
        } else {
