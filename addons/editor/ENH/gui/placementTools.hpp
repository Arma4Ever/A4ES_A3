#define ENH_PlacementTools_POS_X_TEXT 1 * GRID_W
#define ENH_PlacementTools_POS_X_VALUE 25 * GRID_W
#define ENH_PlacementTools_WIDTH_TEXT 23 * GRID_W
#define ENH_PlacementTools_WIDTH_VALUE 36 * GRID_W
#define ENH_PlacementTools_WIDTH_HEADER 60 * GRID_W

#define ENH_PlacementTools_ORIGIN_X safeZoneX + 6 * GRID_W
#define ENH_PlacementTools_ORIGIN_Y  safezoneY	+ 18 * GRID_H
...
class ENH_PlacementTools
{
	...
	class ControlsBackground
	{
		...
		{
			x = ENH_PlacementTools_ORIGIN_X;
			y = ENH_PlacementTools_ORIGIN_Y + CTRL_DEFAULT_H;
			w = 64 * GRID_W;
			h = 120 * GRID_H;
		};
		...
		{
			idc = 250;
			x = ENH_PlacementTools_ORIGIN_X + 1 * GRID_W;
			y = ENH_PlacementTools_ORIGIN_Y + 113 * GRID_H;
			w = 62 * GRID_W;
			h = CTRL_DEFAULT_H;
			rows = 1;
			columns = 7;
		...
		class CurrentValue: ctrlEdit
		{
			idc = 120;
			x = ENH_PlacementTools_ORIGIN_X + 1 * GRID_W;
			y = ENH_PlacementTools_ORIGIN_Y + 119 * GRID_H;
			w = 30 * GRID_W;
			h = CTRL_DEFAULT_H;
			canModify = false;
		};
 		class SelectCenter: ctrlButtonPictureKeepAspect
		{
			...
			x = ENH_PlacementTools_ORIGIN_X + 32 * GRID_W;
			y = ENH_PlacementTools_ORIGIN_Y + 119 * GRID_H;
			w = CTRL_DEFAULT_H;
			h = CTRL_DEFAULT_H;
		...
		{
			x = ENH_PlacementTools_ORIGIN_X + 40 * GRID_W;
			y = ENH_PlacementTools_ORIGIN_Y + 119 * GRID_H;
			w = ENH_PlacementTools_WIDTH_TEXT;
			h = CTRL_DEFAULT_H;
		};
	};
	class Controls
	{
		...
		{
			x = ENH_PlacementTools_ORIGIN_X;
			y = ENH_PlacementTools_ORIGIN_Y +  6 * GRID_H;
			w = 64 * GRID_W;
			h = 105 * GRID_H;
			class Controls
			{
				class CircularHeader: ctrlStaticFooter
				{
					...
					x = ENH_PlacementTools_POS_X_TEXT;
					y = 1 * GRID_W;
					w = ENH_PlacementTools_WIDTH_HEADER;
					h = CTRL_DEFAULT_H;
				};
				...
				{
					idc = 10;
					x = ENH_PlacementTools_POS_X_VALUE;
					y = 7 * GRID_H;
					w = ENH_PlacementTools_WIDTH_VALUE;
					h = CTRL_DEFAULT_H;
					sliderRange[] = {0,200};
				...
				{
					text = "N";
					x = ENH_PlacementTools_POS_X_VALUE + 8 * GRID_W;
					y = 85 * GRID_H;
					w = CTRL_DEFAULT_H;
					h = CTRL_DEFAULT_H;
				...
				{
					text = "E";
					x = ENH_PlacementTools_POS_X_VALUE + 16 * GRID_W;
					y = 91 * GRID_H;
					w = CTRL_DEFAULT_H;
					h = CTRL_DEFAULT_H;
	 			...
	 			class OrientRandom: ctrlButtonPictureKeepAspect
				{
					...
					x = ENH_PlacementTools_POS_X_VALUE + 24 * GRID_W;
					y = 85 * GRID_H;
					w = CTRL_DEFAULT_H;
					h = CTRL_DEFAULT_H;
