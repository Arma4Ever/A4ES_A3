#define ENH_NameObjects_DIALOG_W 70
#define ENH_NameObjects_DIALOG_H 30
...
class ENH_NameObjects
{
	...
	class ControlsBackground
	{
		...
		{
			x = CENTERED_X(ENH_NameObjects_DIALOG_W);
			y = DIALOG_TOP + CTRL_DEFAULT_H;
			w = ENH_NameObjects_DIALOG_W * GRID_W;
			h = ENH_NameObjects_DIALOG_H * GRID_H;
		};
	};
	class Controls
	{
		...
		class VariableName: ctrlStatic
		{
			...
			w = ENH_NameObjects_DIALOG_W * GRID_W - 4 * GRID_W;
			h = CTRL_DEFAULT_H;
		};
		class VariableNameValue: ctrlEdit
		{
			idc = 1000;
			x = CENTERED_X(ENH_NameObjects_DIALOG_W) + 1 * GRID_W;
			y = DIALOG_TOP + 12 * GRID_H;
			w = ENH_NameObjects_DIALOG_W * GRID_W - 2 * GRID_W;
			h = CTRL_DEFAULT_H;
		};
		...
		class RemoveNames: ctrlButton
		{
			...
			x = CENTERED_X(ENH_NameObjects_DIALOG_W) + 42 * GRID_W;
			y = DIALOG_TOP + 6 * GRID_H;
			w = 27 * GRID_W;
			h = CTRL_DEFAULT_H;
