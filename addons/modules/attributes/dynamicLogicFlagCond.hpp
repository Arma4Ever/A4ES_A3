...
class GVAR(dynamicLogicFlagCond): Type {
    attributeLoad = QUOTE(_this call FUNC(dynamicLogicFlagCond_attributeLoad));
    attributeSave = QUOTE(_this call FUNC(dynamicLogicFlagCond_attributeSave));
