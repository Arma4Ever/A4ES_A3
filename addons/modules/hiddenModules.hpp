...
HIDE_MODULE(tfar_ModuleTaskForceRadioEnforceUsage,Module_F);
HIDE_MODULE(tfar_ModuleTaskForceRadioFrequencies,Module_F);
HIDE_MODULE(tfar_ModuleTaskForceRadio,Module_F);
