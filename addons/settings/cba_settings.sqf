...
force force ace_magazinerepack_timePerBeltLink = 6.5;
...
force force ace_medical_playerDamageThreshold = 3.6;
...
force force ace_medical_treatment_cprSuccessChance = 0.76;
