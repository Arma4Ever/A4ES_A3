#include "\x\grad_trenches\addons\functions\script_component.hpp"
/*
...
TRACE_3("grad_removeTrench",_trench,_unit,_switchingDigger);
...
private _fnc_onFinish = {
    ...
    // A4ES
    ["a4es_trenchRemoved", [_unit, typeOf _trench]] call CBA_fnc_serverEvent;
    // A4ES
